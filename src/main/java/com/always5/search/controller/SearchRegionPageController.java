 ...
 */
@WebServlet("/searchRegion.sc")
public class SearchRegionPageController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SearchRegionPageController() {
        super();
...
//		System.out.println(list);
		...
		RequestDispatcher view = request.getRequestDispatcher("WEB-INF/views/search/searchRegion.jsp");
