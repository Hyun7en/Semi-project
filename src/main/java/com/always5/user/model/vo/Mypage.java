...
public class Mypage {
	...
	public Mypage(String authority, String userId, String userPwd, String userName, String nickName, String userBirth,
	...
	public String toString() {
		return "Mypage [userNo=" + userNo + ", Authority=" + Authority + ", userId=" + userId + ", userPwd=" + userPwd
