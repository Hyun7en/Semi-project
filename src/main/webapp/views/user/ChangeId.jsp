...
<body>
	<div class="changeId">
		...
		<!-- X버튼 -->
		<img class="logo"
			src="http://localhost:8001/always5/resources/file/upfile/user_upfile/changeId-img/ph-x-thin.svg" />
		...
		<img class="line-pass"
			src="http://localhost:8001/always5/resources/file/upfile/user_upfile/changeId-img/line-47.svg" />

		<!-- 사용자 이메일 입력 -->
		<div class="email-preview">
			<img class="mdi-email-icon"
				src="http://localhost:8001/always5/resources/file/upfile/user_upfile/changeId-img/mdi-light-email.svg" />
