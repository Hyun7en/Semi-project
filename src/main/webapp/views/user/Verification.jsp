...
<body>
	<div class="Verification">
		...
		<!-- X버튼 -->
		<img class="logo"
			src="http://localhost:8001/always5/resources/file/upfile/user_upfile/Verification-img/ph-x-thin.svg" />

		<!-- 본인인증 로고 -->
		<div class="Verification-main">
			<img class="Verification-image"
				src="http://localhost:8001/always5/resources/file/upfile/user_upfile/Verification-img/2x.png" />
		</div>
		...
		<div class="Verification-wrapper">
			...
			<div class="Verification-gender-box">
				<input type="submit" name="gender-male-submit"
					class="gender-male-submit" value="남자"> <input type="submit"
					name="gender-female-submit" class="gender-female-submit" value="여자">
			</div>
		</div>
