<%@ page language="java" contentType="text/html; charset=UTF-8" rank
	pageEncoding="UTF-8"%>
...
<body>
	<form action="MypageReview.ui" class="MypageReview-Container"
		method="POST">
		<div class="MypageReview">

			<!-- 작성 리뷰 -->
			<div class="MypageReview-title-box">
				<div class="MypageReview-Name">왕고기</div>
				<div class="MypageReview-Name2">님의 추천 리뷰</div>
			</div>
			...
			<div class="reviewbox01">
				<div class="reviewbox-wrapper">
					...
					<div class="crown-rank">
						<img class="crown"
							src="http://localhost:8001/always5/resources/file/user_img/MypagReviewGoods-img/ccrown.png" />
						<img class="crown"
							src="http://localhost:8001/always5/resources/file/user_img/MypagReviewGoods-img/crown.png" />
						<img class="crown"
							src="http://localhost:8001/always5/resources/file/user_img/MypagReviewGoods-img/crown.png" />
						<img class="crown"
							src="http://localhost:8001/always5/resources/file/user_img/MypagReviewGoods-img/crown.png" />
					...
					<img class="reviewbox-preview01" src="img/한식01.jpg" /> <img
						class="reviewbox-preview02" src="img/한식02.jpg" /> <img
						class="reviewbox-preview03" src="img/한식03.jpg" />
			...
			<div class="reviewbox02">
				<div class="reviewbox-wrapper">
					...
					<img class="reviewbox-preview01"
						src="http://localhost:8001/always5/resources/file/user_img/MypagReviewGoods-img/한식01.jpg" />
					<img class="reviewbox-preview02"
						src="http://localhost:8001/always5/resources/file/user_img/MypagReviewGoods-img/한식02.jpg" />
					<img class="reviewbox-preview03"
						src="http://localhost:8001/always5/resources/file/user_img/MypagReviewGoods-img/한식03.jpg" />
			...
			<script
				src="http://localhost:8001/always5/resources/js/user_js/MyPageReviewGoods.js"></script>
		</div>
	</form>
</body>
