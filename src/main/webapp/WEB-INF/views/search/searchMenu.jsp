				...
				<%@ include file="../common/header.jsp" %>
					...
					<main style="margin-top: 230px;">
						<section class="search-nav" style="padding: 0px;">
							<div>
								<a class="백반">
									<img src="${pageContext.request.contextPath}/resources/file/search_img/백반메뉴.png"
										alt="">
									<p>백반</p>
								</a>
							</div>
							<div>
								<a class="찌개">
									<img src="${pageContext.request.contextPath}/resources/file/search_img/찌개메뉴.png"
										alt="">
									<p>찌개</p>
								</a>
							</div>
							<div>
								<a class="국밥">
									<img src="${pageContext.request.contextPath}/resources/file/search_img/국밥메뉴.png"
										alt="">
									<p>국밥</p>
								</a>
							</div>
							<div>
								<a class="제육">
									<img src="${pageContext.request.contextPath}/resources/file/search_img/제육메뉴.png"
										alt="">
									<p>제육</p>
								</a>
							</div>
							<div>
								<a class="돈가스">
									<img src="${pageContext.request.contextPath}/resources/file/search_img/돈가스메뉴.png"
										alt="">
									<p>돈가스</p>
								</a>
							</div>
							<div>
								<a class="김밥">
									<img src="${pageContext.request.contextPath}/resources/file/search_img/김밥메뉴.png"
										alt="">
									<p>김밥</p>
								</a>
							</div>
							<div>
								<a class="초밥">
									<img src="${pageContext.request.contextPath}/resources/file/search_img/초밥메뉴.png"
										alt="">
									<p>초밥</p>
								</a>
							</div>
							<div>
								<a class="패스트푸드">
									<img src="${pageContext.request.contextPath}/resources/file/search_img/햄버거메뉴.png"
										alt="">
									<p>패스트푸드</p>
								</a>
							</div>
								...
								<div class="search-best-img">
									<c:forEach var="sr" begin="1" end="3" items="${list}">
										<div>
											...
											<div>
												<p class="res-name">
													<span><b>${sr.restName}</span><span>&nbsp;&nbsp;</span></b></p>
												<p class="res-location">
													<span>한식집</span><span>&nbsp;&nbsp;${sr.restAddress}</span></p>
						...
						<section class="search-result">
							...
							<c:forEach var="sr" items="${list}">
								<div>
									...
									<div>
										<p class="res-name">
											<span><b>${sr.restName}1111</span><span>&nbsp;&nbsp;</span></b></p>
										<p class="res-location">
											<span>한식집</span><span>&nbsp;&nbsp;${sr.restAddress}</span></p>
										<p class="res-explain"><b>${sr.restIntro}</b></p>
									</div>
